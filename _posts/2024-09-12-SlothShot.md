...
title: "Sloth-Shot"
date: 2024-09-12
excerpt: "An exhibit at the Schmiede 24"
tags: [sloth, schmiede, exhibit]
project: true
feature: assets/img/schmiede/sloth2.webp
tiled_bg: false
comments: false
---
...
<h1 style="text-align:center"><b>"Do you feel slow today?"</b></h1>
...
{% capture images %}
	{{site.url}}/assets/img/schmiede/SandPit.jpeg
	{{site.url}}/assets/img/schmiede/slothTargets.jpeg
	
{% endcapture %}
{% include gallery images=images caption="Setup of the exhibit" cols=2 %}
...
{% capture images %}
	{{site.url}}/assets/img/schmiede/SchmiedeLager.jpeg
	{{site.url}}/assets/img/schmiede/SchmiedeSling.jpeg
	{{site.url}}/assets/img/schmiede/SchmiedeSloth.jpeg
	{{site.url}}/assets/img/schmiede/SchmiedeSpace.jpeg
	{{site.url}}/assets/img/schmiede/SchmiedeSpace2.jpeg
	{{site.url}}/assets/img/schmiede/SlingPrototype.jpeg
	{{site.url}}/assets/img/schmiede/slothQuestion.jpeg
	{{site.url}}/assets/img/schmiede/slothSling.jpeg
...
{% capture images %}
	{{site.url}}/assets/img/schmiede/ShortStory.jpeg
{% endcapture %}
{% include gallery images=images caption="Transcript of my aweful handwriting: <br/>Bendy the Spoon is spooning a spoonfull of quite spoonable food. <br/>Bendy is content with his spooning duty even though it's quite the spoonfull. <br/>Bendy's head is getting heavy. <br/>Bendy's head is bending a lot, bending so much, almost snapping. <br/>Suddnly the spoon load was gone, Bendy was happy." cols=1 %}
