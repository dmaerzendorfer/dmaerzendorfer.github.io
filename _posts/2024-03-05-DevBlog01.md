...
**As a little sidenote:** personally I always tend to call it the tennisball-snake model (since it looks like a snake that has swallod a few tennisballs)   
Just now I was once again wondering why my google search for "tennisball-snake design model" didn't get me any good results ^^'
{: .notice}
...
At the be beginning we started with defining in what ball-park our mechanic should be. We sketched out some rough guidelines:
...
With this we started to write down some possible ideas that fit the theme. Let's just look at some sketches so I dont have to explain every single one:
